...
./GenBiosId -i Conf/BiosId.env -o $BUILD_PATH/$Arch/BiosId.bin
...
cat Stitch/IFWIHeader/IFWI_HEADER.bin ./Vlv2TbltDevicePkg/Restricted/SEC/$SEC_VERSION/VLV_SEC_REGION.bin Stitch/IFWIHeader/Vacant.bin $BIOS_Name > Stitch/$BIOS_ID
