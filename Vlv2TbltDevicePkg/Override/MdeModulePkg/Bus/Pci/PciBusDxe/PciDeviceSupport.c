  ...
  )
{
  ...
  if(mSystemConfiguration.PrimaryVideoAdaptor == 0 &&
    !(PciIoDevice->DeviceNumber ==2 && PciIoDevice->FunctionNumber == 0)){
      ...
      if (((PciConfigHeader.Hdr.ClassCode[2] == 0) &&
        (PciConfigHeader.Hdr.ClassCode[1] == 1))|| 3 == PciConfigHeader.Hdr.ClassCode[2]) {
         DEBUG ((EFI_D_ERROR, "IGD is primary, not register other VGA!!\n"));
