  ...
  )
{
  ...
  if (((PciData.Hdr.ClassCode[0] & IDE_PRIMARY_OPERATING_MODE) == 0) && (PciData.Hdr.ClassCode[1] == PCI_CLASS_MASS_STORAGE_IDE)) {
  ...
  if (((PciData.Hdr.ClassCode[0] & IDE_SECONDARY_OPERATING_MODE) == 0) && (PciData.Hdr.ClassCode[1] == PCI_CLASS_MASS_STORAGE_IDE)) {
